...
const description =
  "Yes, foreigners can buy property in Oman. A 2026 guide to ITC freehold vs usufruct, which zones allow foreign ownership, residency by property, and the escrow law. By an Oman property advisor.";
const canonical =
