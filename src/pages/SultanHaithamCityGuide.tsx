          ...
          <div className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-warmGray/10 border border-gold/20 rounded-lg p-6">
                ...
                <p className="text-muted-foreground">
                  Foreign ownership allowed with freehold titles. Sultan Haitham City has its own residency rule, set by the Ministry of Housing for the future cities and Surouh projects: once 30% of the price is paid, the buyer can apply for a two-year renewable residency, before handover. At OMR 50,000 or less it covers the buyer only; above OMR 50,000 it covers first-degree family too. It needs a separate security clearance, so ownership does not guarantee it. Ask before paying the 30%. Full rules for investors and their families. Full guide:{" "}
